...
if(inputImage != null){ // inputUmage 요소가 화면에 존재할 때
    ...
    inputImage.addEventListener("change",function(){
        ...
        // console.log(this.files[0]); // 파일 목록에서 첫 번재 파일 객체를 선택
