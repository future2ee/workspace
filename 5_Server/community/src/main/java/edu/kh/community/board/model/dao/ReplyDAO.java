	...
	public List<Reply> selectReplyList(Connection conn, int boardNo) throws Exception{
		...
		try {
			...
			while(rs.next()) {
				...
				rep.setReplyNo(rs.getInt(1));
				rep.setReplyContent(rs.getString(2));
				rep.setCreateDate(rs.getString(3));
				rep.setBoardNo(rs.getInt(4));
				rep.setMemberNo(rs.getInt(5));
				rep.setMemberNickname(rs.getString(6));
				rep.setProfileImage(rs.getString(7));
				
				
				rList.add(rep); // 리스트 추가 
