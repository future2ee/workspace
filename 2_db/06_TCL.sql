...
EX) ENSERT 수행 ------------------------------> DB 반영(X)
    ...
    3) SAVEPOINT : 메모리 버퍼(트랜잭션에) 저장 지점을 정의하여
                    ROLLBACDK 수행시 전체 작업을 삭제하는 것이 아닌
    ...
    SAVEPOINT 포인트명2;
    ...
    ROLLBACK TO 포인트명1; -- 포인트 1 지점까지 데이터 변경 사항 삭제
