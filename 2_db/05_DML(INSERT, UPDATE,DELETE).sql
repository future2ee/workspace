-- *** DML (Data Manipullation Language) : 데이터 조작 언어
...
-- 1) INSERT INTO 테이블면 VALUES(데이터, 데이터,...)
-- 테이블에 모든 컬럼에 대한 값을 INSER T할 때 사용
-- INSERT하고자 하는 컬럼이 모든 컬럼인 경우 컬럼명 생략 가능
-- 단, 컬럼의 순서를 지켜서 VALUES에 값을 기입해야 함
INSERT INTO EMPLOYEE2
VALUES(900, '이미래', '990204-2345678', 'msldd453@naver.com','01057131234',
        'D1', 'J3', 'S2', 30000000,0.2,200,SYSDATE, NULL, 'N');
...
INSERT INTO EMPLOYEE2(EMP_ID, EMP_NAME, EMP_NO, EMAIL, PHONE, DEPT_CODE, JOB_CODE,
                        SAL_LEVEL, SALARY)
VALUES(900,'이미래','990204-2345678', 'msldd453@naver.com','01057131234', 'D1', 'J3',
            'S2', 30000000);
...
-- 서브쿼리(SQL에 대부에 포함된 SELECT문)를 이용한 삽입(VALUES 생략)
...
-- 유재식 급여
SELECT SALARYFROM FROM EMPLOYEE2 WHERE EMP_NAME = '유재식'; --3400000
--유재식 보너스
