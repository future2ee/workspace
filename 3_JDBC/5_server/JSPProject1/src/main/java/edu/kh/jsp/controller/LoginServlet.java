...
public class LoginServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resq) throws ServletException, IOException {
		...
		// 요청시 전달된 input 태그의 값(== parameter) 얻어오기
		// (파라미터는 모두 스트링 타입이다!)
		...
		//   반대로 HTML코드에 Java코들르 쓸 수 있게 하는 문서
		
		// * JSP 생성 폴더 위치
		// -> Webapp/WEB_INF 폴더 내부에 생성
		...
		// req.serAttribute(String key, Object value);
		// - key는 string(문자열)
		...
		// 요청 발송자를 이용하여 req, resq 객체를 전송(forward)함
