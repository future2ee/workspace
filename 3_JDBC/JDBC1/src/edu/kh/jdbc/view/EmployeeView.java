...
public class EmployeeView {
	...
	public void displayMenu() {
		...
		do {
			try {
	            ...
	            default : System.out.println("잘못 입력하셨숩니다. 다시 입력해주세요");
	            
	            }
				
			} catch (InputMismatchException e) {
				System.out.println("입력형식이 잘못되었습니다. 다시 시도 해주세요.");
				menuNum =-1;
	...
	public void deleteEmployee() {
		...
		// EMPLOYEE2 테이블에서
		// 사번을 입력 받고 일치하는 사번을 가진 사우너 정보 삭제(DELETE)
		
		// 조건1 : PreparedStatement 사용
		...
		if(result >0) {
			...
			System.out.println("일치하는 사번의 사원이 없숩니다.");
		}
	...
	public void updateEmployee(){
		...
		int input = inputEmpId(); //사번으로 입력받는 메소드 호출 후 결과를 반환 받기
	...
	public void updateBonus() {
		...
		//			 PreparedStatement
		System.out.println("[부서의 보너스율 모두 수정]");
		...
		if(result > 0) {
			System.out.printf("%s 부서의 보너스 율이 %.1f으로 변경되었습니다.\n", deptCode, bonus);
