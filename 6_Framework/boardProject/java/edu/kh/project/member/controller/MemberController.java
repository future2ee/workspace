...
public class MemberController {
	...
	public String login(/* @ModelAttribute */ Member inputMember) {
		...
		// -DTO에 기본생성자가 반드시 존재해야 한다!
		// -DTO에 setter가 반드시 존재해야 한다!
		
		// *** @ModelAttribute 어노테이션 생략이 가능하다! ***
	...
	public String signUp() {
		...
		// WEB-INF/views/member/signUp.jsp forword(요청 위임)
		// -> ViewResolver가 prefix, surfix를 리턴 값 앞, 뒤에 붙임
	...
	public String signUp(Member inputMember
		...
		// String[] memberAddress : 
		// input name = "memberAddress" 3게가 저장된 배열
		...
		// 리다이렉트 시 session에 잠깐 올렸다가 내려오도록 세팅
