...
<body>
	...
	<%-- 누가(로그인한 회원 번호) 어던 게시글 (현재 게시글 번호) 좋아요를 클릭/cnlth

		 로그인한 회원 번호 얻어오기
		 1) ajax로 session에 있는 loginMember의 memberNo를 반환
		 2) HTML 요소에 로그인한 회원의 번호를 숨겨 놓고 JS로 얻어오기
		 3) jsp 파일 제일 위에있는 script 태그에 JS + EL 이용해서 전연 변수로 선언해두기
	 --%>
