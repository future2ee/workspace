...
// 고전 이벤트 모델 확인하기
    ...
    // 렌더링 되지 않은 요소에는 이벤트 관령 동작을 추가할 수 없다!!
    //  (문제 원인 : HTML 코드 해석 순서(위 -> 아래))

    // --> 해결 방법 : HTML 요소가 먼저 렌더링 된 후 JS코드 수행
...
// test3에 이미 click 이벤트에 대한 동작이 종재하는데 
// 중복해서 적용
document.getElementById("test3").addEventListener("click", function(){
...
// 방법 2. onsubmit을 이용해서 form 태그 제출하는 것을 막는 방법
function checkIn2(){
